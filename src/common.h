...
#define DEFAULT_DATA_SMALL                                                     \
  1 << 15 // Constant for ArrayChain. Array size: ~ 32k (32768)
#define DEFAULT_DATA_MEDIUM                                                    \
  1 << 18 // Constant for ArrayChain. Array size: ~262k (262144)
#define DEFAULT_DATA_LARGE                                                     \
  1 << 19 // Constant for ArrayChain. Array size: ~524k (524288)

/* NOTE: Please ignore these options (V_a, V_b) since they are for the currently
 * incorrect diffuseChem() */
// #define V_a
#define V_b
// #define PRINT_KERNEL
 ...
 */
template <typename T> bool isModified(T *arr) {
