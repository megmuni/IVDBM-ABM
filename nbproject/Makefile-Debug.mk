...
.build-conf: ${BUILD_SUBPROJECTS}
	"${MAKE}"  -f nbproject/Makefile-${CND_CONF}.mk ${CND_DISTDIR}/${CND_CONF}/nyvonna_abm

${CND_DISTDIR}/${CND_CONF}/nyvonna_abm: ${OBJECTFILES}
	${MKDIR} -p ${CND_DISTDIR}/${CND_CONF}
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/nyvonna_abm ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/examples/ex_diffuse_temperature.o: examples/ex_diffuse_temperature.cpp 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/ex_diffuse_temperature.o examples/ex_diffuse_temperature.cpp

${OBJECTDIR}/examples/test_not_main.o: examples/test_not_main.cpp 
	${MKDIR} -p ${OBJECTDIR}/examples
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/examples/test_not_main.o examples/test_not_main.cpp

${OBJECTDIR}/findCudaTests/July3CUDA.o: findCudaTests/July3CUDA.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/July3CUDA.o findCudaTests/July3CUDA.cu

${OBJECTDIR}/findCudaTests/July3main.o: findCudaTests/July3main.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/July3main.o findCudaTests/July3main.cu

${OBJECTDIR}/findCudaTests/conflict-main.o: findCudaTests/conflict-main.cpp 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/conflict-main.o findCudaTests/conflict-main.cpp

${OBJECTDIR}/findCudaTests/conflict.o: findCudaTests/conflict.cpp 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/conflict.o findCudaTests/conflict.cpp

${OBJECTDIR}/findCudaTests/conflict.o: findCudaTests/conflict.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/conflict.o findCudaTests/conflict.cu

${OBJECTDIR}/findCudaTests/main-ptx.o: findCudaTests/main-ptx.cpp 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/main-ptx.o findCudaTests/main-ptx.cpp

${OBJECTDIR}/findCudaTests/main.o: findCudaTests/main.cc 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/main.o findCudaTests/main.cc

${OBJECTDIR}/findCudaTests/main_for_lib.o: findCudaTests/main_for_lib.cc 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/main_for_lib.o findCudaTests/main_for_lib.cc

${OBJECTDIR}/findCudaTests/myTest.o: findCudaTests/myTest.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/myTest.o findCudaTests/myTest.cu
...
${OBJECTDIR}/findCudaTests/path\ with\ spaces/conflict.o: findCudaTests/path\ with\ spaces/conflict.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/path\ with\ spaces/conflict.o findCudaTests/path\ with\ spaces/conflict.cpp

.NO_PARALLEL:${OBJECTDIR}/findCudaTests/path\ with\ spaces/conflict.o
${OBJECTDIR}/findCudaTests/path\ with\ spaces/conflict.o: findCudaTests/path\ with\ spaces/conflict.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests spaces
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/path\ with\ spaces/conflict.o findCudaTests/path\ with\ spaces/conflict.cu
...
${OBJECTDIR}/findCudaTests/path\ with\ spaces/no-conflict.o: findCudaTests/path\ with\ spaces/no-conflict.cpp 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests spaces
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/path\ with\ spaces/no-conflict.o findCudaTests/path\ with\ spaces/no-conflict.cpp

.NO_PARALLEL:${OBJECTDIR}/findCudaTests/path\ with\ spaces/no-conflict.o
${OBJECTDIR}/findCudaTests/path\ with\ spaces/no-conflict.o: findCudaTests/path\ with\ spaces/no-conflict.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests spaces
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/path\ with\ spaces/no-conflict.o findCudaTests/path\ with\ spaces/no-conflict.cu

${OBJECTDIR}/findCudaTests/test_bin.o: findCudaTests/test_bin.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/test_bin.o findCudaTests/test_bin.cu

${OBJECTDIR}/findCudaTests/test_lib.o: findCudaTests/test_lib.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/test_lib.o findCudaTests/test_lib.cu

${OBJECTDIR}/findCudaTests/test_ptx.o: findCudaTests/test_ptx.cu 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/test_ptx.o findCudaTests/test_ptx.cu

${OBJECTDIR}/findCudaTests/test_with_spaces.o: findCudaTests/test_with_spaces.cpp 
	${MKDIR} -p ${OBJECTDIR}/findCudaTests
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/findCudaTests/test_with_spaces.o findCudaTests/test_with_spaces.cpp
...
${OBJECTDIR}/src/Agent/Agent.o: src/Agent/Agent.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -Isrc/World -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Agent/Agent.o src/Agent/Agent.cpp

${OBJECTDIR}/src/Agent/Usr_Agents/Collagen.o: src/Agent/Usr_Agents/Collagen.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Agent/Usr_Agents
	${RM} $@.d
	$(COMPILE.cc) -g -Isrc/World -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Agent/Usr_Agents/Collagen.o src/Agent/Usr_Agents/Collagen.cpp

${OBJECTDIR}/src/Agent/Usr_Agents/Chondrocyte.o: src/Agent/Usr_Agents/Chondrocyte.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Agent/Usr_Agents
	${RM} $@.d
	$(COMPILE.cc) -g -Isrc/World -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Agent/Usr_Agents/Chondrocyte.o src/Agent/Usr_Agents/Chondrocyte.cpp

${OBJECTDIR}/src/Agent/Usr_Agents/Hyaluronan.o: src/Agent/Usr_Agents/Hyaluronan.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Agent/Usr_Agents
	${RM} $@.d
	$(COMPILE.cc) -g -Isrc/World -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Agent/Usr_Agents/Hyaluronan.o src/Agent/Usr_Agents/Hyaluronan.cpp

${OBJECTDIR}/src/Agent/Usr_Agents/Macrophage.o: src/Agent/Usr_Agents/Macrophage.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Agent/Usr_Agents
	${RM} $@.d
	$(COMPILE.cc) -g -Isrc/World -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Agent/Usr_Agents/Macrophage.o src/Agent/Usr_Agents/Macrophage.cpp

${OBJECTDIR}/src/Agent/Usr_Agents/Neutrophil.o: src/Agent/Usr_Agents/Neutrophil.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Agent/Usr_Agents
	${RM} $@.d
	$(COMPILE.cc) -g -Isrc/World -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Agent/Usr_Agents/Neutrophil.o src/Agent/Usr_Agents/Neutrophil.cpp

${OBJECTDIR}/src/Agent/Usr_Agents/Platelet.o: src/Agent/Usr_Agents/Platelet.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Agent/Usr_Agents
	${RM} $@.d
	$(COMPILE.cc) -g -Isrc/World -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Agent/Usr_Agents/Platelet.o src/Agent/Usr_Agents/Platelet.cpp

${OBJECTDIR}/src/FieldVariable/FieldVariable.o: src/FieldVariable/FieldVariable.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/FieldVariable
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/FieldVariable/FieldVariable.o src/FieldVariable/FieldVariable.cpp
...
${OBJECTDIR}/src/FieldVariable/Usr_FieldVariables/WHChemical.o: src/FieldVariable/Usr_FieldVariables/WHChemical.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/FieldVariable/Usr_FieldVariables/WHChemical.o src/FieldVariable/Usr_FieldVariables/WHChemical.cpp

${OBJECTDIR}/src/Patch/Patch.o: src/Patch/Patch.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/Patch
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/Patch/Patch.o src/Patch/Patch.cpp

${OBJECTDIR}/src/World/Lattice/Lattice.o: src/World/Lattice/Lattice.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/World/Lattice
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/World/Lattice/Lattice.o src/World/Lattice/Lattice.cpp
...
${OBJECTDIR}/src/World/Usr_World/woundHealingWorld.o: src/World/Usr_World/woundHealingWorld.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/World/Usr_World/woundHealingWorld.o src/World/Usr_World/woundHealingWorld.cpp

${OBJECTDIR}/src/World/World.o: src/World/World.cpp 
	${MKDIR} -p ${OBJECTDIR}/src/World
	${RM} $@.d
	$(COMPILE.cc) -g -MMD -MP -MF $@.d -o ${OBJECTDIR}/src/World/World.o src/World/World.cpp
...
.clean-conf: ${CLEAN_SUBPROJECTS}
	...
	${RM} ${CND_DISTDIR}/${CND_CONF}/nyvonna_abm
